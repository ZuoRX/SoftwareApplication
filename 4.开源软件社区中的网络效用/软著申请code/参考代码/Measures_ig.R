...
for (i in 1:28402) { #28402		
		...
		for (year in 1999:2005) {
		  for (month in 0:12) {
		      filename <- paste("F:/OSS_Project/finaldatfiles1010/OssMMNet", year, "_", month, "_", i, ".net", sep="")
					...
					if (file.exists(filename)) {
						...
						V(gig)$load <- tempa; # store the load of every vertex into an attribute of this graph
